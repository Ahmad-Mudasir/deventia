  ...
  return (
    <section className="p-20">
      ...
      <div>
        ...
        />
        <Heading text={"Security and Accounts"} />
        <Paragraph
          text={
        ...
        />
        <Heading text={"Termination Of Access"} />
        <Paragraph
          text={
        ...
        />
        <Heading text={"International Use"} />
        <Paragraph
          text={
        ...
        />
        <Heading text={"Disclaimer Of Liability"} />
        <Paragraph
          text={
        ...
        />
        <Heading text={"Remedies and Waivers"} />
        <Paragraph
          text={
