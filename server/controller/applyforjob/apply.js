...
async function sendEmail(firstName, lastName, middleName, birthDate, email, phoneNumber, aboutYou, filePath) {
    try {
...
const applyJob = async (req, res) => {
    ...
    upload.single('file')(req, res, async (err) => {
        ...
        try {
            ...
            const fileUrl = file ? `http://localhost:4000/uploads/${file.filename}` : '';
